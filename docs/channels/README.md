...
Ghost connects to you through multiple channels. Choose the one that fits your workflow.

## Available Channels

- **[Telegram](./telegram.md)** — Chat and approve trades from your phone (no dashboard needed)
- **[Web Dashboard](./web-dashboard.md)** — Full-featured browser interface with charts, logs, memory, and scheduler
